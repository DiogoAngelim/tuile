    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncQre_with_order_summary_sidebarfuncklm_editor_assets' );

      function wpfuncQre_with_order_summary_sidebarfuncklm_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncQre_with_order_summary_sidebarfuncklm_block_assets' );

    function wpfuncQre_with_order_summary_sidebarfuncklm_block_assets() {
      $args = array(
