    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncywY_with_related_productsfuncZLe_editor_assets' );

      function wpfuncywY_with_related_productsfuncZLe_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncywY_with_related_productsfuncZLe_block_assets' );

    function wpfuncywY_with_related_productsfuncZLe_block_assets() {
      $args = array(
