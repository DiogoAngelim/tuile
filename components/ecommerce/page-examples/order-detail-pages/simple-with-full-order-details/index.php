    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfunciCC_simple_with_full_order_detailsfuncwkW_editor_assets' );

      function wpfunciCC_simple_with_full_order_detailsfuncwkW_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfunciCC_simple_with_full_order_detailsfuncwkW_block_assets' );

    function wpfunciCC_simple_with_full_order_detailsfuncwkW_block_assets() {
      $args = array(
