    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncYfO_with_background_imagefuncLge_editor_assets' );

      function wpfuncYfO_with_background_imagefuncLge_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncYfO_with_background_imagefuncLge_block_assets' );

    function wpfuncYfO_with_background_imagefuncLge_block_assets() {
      $args = array(
