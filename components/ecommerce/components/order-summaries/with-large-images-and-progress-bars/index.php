    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncXHM_with_large_images_and_progress_barsfuncCNN_editor_assets' );

      function wpfuncXHM_with_large_images_and_progress_barsfuncCNN_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncXHM_with_large_images_and_progress_barsfuncCNN_block_assets' );

    function wpfuncXHM_with_large_images_and_progress_barsfuncCNN_block_assets() {
      $args = array(
