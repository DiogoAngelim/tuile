    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncbKi_simple_justified_on_light_brandfuncBPw_editor_assets' );

      function wpfuncbKi_simple_justified_on_light_brandfuncBPw_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncbKi_simple_justified_on_light_brandfuncBPw_block_assets' );

    function wpfuncbKi_simple_justified_on_light_brandfuncBPw_block_assets() {
      $args = array(
