    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncfus_brand_panel_with_overlapping_imagefunchkX_editor_assets' );

      function wpfuncfus_brand_panel_with_overlapping_imagefunchkX_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncfus_brand_panel_with_overlapping_imagefunchkX_block_assets' );

    function wpfuncfus_brand_panel_with_overlapping_imagefunchkX_block_assets() {
      $args = array(
