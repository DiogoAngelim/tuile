  ...
  "contentOgT": {
    ...
    <div>
      ...
      <span className="block"><RichText tagName="span" value={attributes.contentVKB} default="Ready to dive in?" onChange={ (newtext) =>  {
        setAttributes({ contentVKB: newtext });
      }}
    /></span>
      <span className="block text-indigo-600"><RichText tagName="span" value={attributes.contentWAW} default="Start your free trial today." onChange={ (newtext) =>  {
    ...
    /></span>
                ...
                <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div className="inline-flex rounded-md shadow"> <span className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"><RichText tagName="span" value={attributes.contentQKd} default="Get started" onChange={ (newtext) =>  {
        setAttributes({ contentQKd: newtext });
      }}
    /></span>

                    </div>
                    <div className="ml-3 inline-flex rounded-md shadow"> <span className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50"><RichText tagName="span" value={attributes.contentOgT} default="Learn more" onChange={ (newtext) =>  {
        setAttributes({ contentOgT: newtext });
      }}
    /></span>
    ...
    <div>
      ...
      <span class="block"><RichText.Content value={attributes.contentVKB} /></span>
      <span class="block text-indigo-600"><RichText.Content value={attributes.contentWAW} /></span>
    </h2>

                <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div class="inline-flex rounded-md shadow"> <span class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"><RichText.Content value={attributes.contentQKd} /></span>

                    </div>
                    <div class="ml-3 inline-flex rounded-md shadow"> <span class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50"><RichText.Content value={attributes.contentOgT} /></span>
