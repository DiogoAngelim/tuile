  ...
  "contentUDs": {
    ...
    <div>
      ...
      <span className="block"><RichText tagName="span" value={attributes.contentOHO} default="Ready to dive in?" onChange={ (newtext) =>  {
        setAttributes({ contentOHO: newtext });
      }}
    /></span>
      <span className="block text-indigo-600"><RichText tagName="span" value={attributes.contentmUH} default="Start your free trial today." onChange={ (newtext) =>  {
        setAttributes({ contentmUH: newtext });
      }}
    /></span>
    </h2>

                <div className="mt-8 flex">
                    <div className="inline-flex rounded-md shadow"> <span className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"><RichText tagName="span" value={attributes.contentKgL} default="Get started" onChange={ (newtext) =>  {
        setAttributes({ contentKgL: newtext });
      }}
    /></span>

                    </div>
                    <div className="ml-3 inline-flex"> <span className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200"><RichText tagName="span" value={attributes.contentUDs} default="Learn more" onChange={ (newtext) =>  {
    ...
    <div>
      ...
      <span class="block"><RichText.Content value={attributes.contentOHO} /></span>
      <span class="block text-indigo-600"><RichText.Content value={attributes.contentmUH} /></span>
    </h2>

                <div class="mt-8 flex">
                    <div class="inline-flex rounded-md shadow"> <span class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"><RichText.Content value={attributes.contentKgL} /></span>

                    </div>
                    <div class="ml-3 inline-flex"> <span class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200"><RichText.Content value={attributes.contentUDs} /></span>
