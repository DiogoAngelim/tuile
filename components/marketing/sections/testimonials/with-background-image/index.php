    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncgVQ_with_background_imagefuncscd_editor_assets' );

      function wpfuncgVQ_with_background_imagefuncscd_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncgVQ_with_background_imagefuncscd_block_assets' );

    function wpfuncgVQ_with_background_imagefuncscd_block_assets() {
      $args = array(
