    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncSny_simple_three_columnfuncmmS_editor_assets' );

      function wpfuncSny_simple_three_columnfuncmmS_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncSny_simple_three_columnfuncmmS_block_assets' );

    function wpfuncSny_simple_three_columnfuncmmS_block_assets() {
      $args = array(
