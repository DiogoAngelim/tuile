  ...
  "svgirs": {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgwkQ }
            onChange={ ( value ) => {
              setAttributes({ svgwkQ: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgyvD }
            onChange={ ( value ) => {
              setAttributes({ svgyvD: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgMgt }
            onChange={ ( value ) => {
              setAttributes({ svgMgt: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgkWm }
            onChange={ ( value ) => {
              setAttributes({ svgkWm: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgirs }
            onChange={ ( value ) => {
              setAttributes({ svgirs: value });
            } }
          />
        </div>
      </PanelRow>
    ...
    <div>
        <footer className="bg-white" aria-labelledby="footer-heading">
             <h2 id="footer-heading" className="sr-only"><RichText tagName="span" value={attributes.contentBqq} default="Footer" onChange={ (newtext) =>  {
        setAttributes({ contentBqq: newtext });
      }}
    /></h2>
      ...
      <MediaUpload 
        onSelect={ (media) => { 
          setAttributes({ 
            imageurlHyt: media.url,
            imagealtjRy: media.alt
          }); 
        } }
        type="image" 
        render={ ({ open }) => (
          <img
            src={ attributes.imageurlHyt } 
            alt={ attributes.imagealtjRy } 
            onClick={ open } 
            className="h-10"
          /> 
        )} 
      />
                        <p className="text-gray-500 text-base">
                            <RichText tagName="span" value={attributes.contentZno} default="Making the world a better place through constructing elegant hierarchies." onChange={ (newtext) => { setAttributes({ contentZno: newtext }); }} /></p>
                        <div className="flex space-x-6"> <span className="text-gray-400 hover:text-gray-500">
            <span className="sr-only"><RichText tagName="span" value={attributes.contentvwq} default="Facebook" onChange={ (newtext) =>  {
        setAttributes({ contentvwq: newtext });
      }}
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgwkQ }}
        >
      </svg>
      
                            </span> <span className="text-gray-400 hover:text-gray-500">
            <span className="sr-only"><RichText tagName="span" value={attributes.contentQAW} default="Instagram" onChange={ (newtext) =>  {
        setAttributes({ contentQAW: newtext });
      }}
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgyvD }}
        >
      </svg>
      
                            </span> <span className="text-gray-400 hover:text-gray-500">
            <span className="sr-only"><RichText tagName="span" value={attributes.contentyal} default="Twitter" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgMgt }}
        >
      </svg>
      
                            </span> <span className="text-gray-400 hover:text-gray-500">
            <span className="sr-only"><RichText tagName="span" value={attributes.contentceH} default="GitHub" onChange={ (newtext) =>  {
        setAttributes({ contentceH: newtext });
      }}
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgkWm }}
        >
      </svg>
      
                            </span> <span className="text-gray-400 hover:text-gray-500">
            <span className="sr-only"><RichText tagName="span" value={attributes.contentJuq} default="Dribbble" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgirs }}
        >
      </svg>
                    ...
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                 <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText tagName="span" value={attributes.contentpTJ} default="Solutions" onChange={ (newtext) =>  {
        setAttributes({ contentpTJ: newtext });
      }}
    /></h3>

                                <ul role="list" className="mt-4 space-y-4">
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentItq} default="Marketing" onChange={ (newtext) =>  {
        setAttributes({ contentItq: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentAkd} default="Analytics" onChange={ (newtext) =>  {
        setAttributes({ contentAkd: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentand} default="Commerce" onChange={ (newtext) =>  {
        setAttributes({ contentand: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentOFX} default="Insights" onChange={ (newtext) =>  {
        setAttributes({ contentOFX: newtext });
      }}
    /></span>
                            ...
                            <div className="mt-12 md:mt-0">
                                 <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText tagName="span" value={attributes.contentPpD} default="Support" onChange={ (newtext) =>  {
        setAttributes({ contentPpD: newtext });
      }}
    /></h3>

                                <ul role="list" className="mt-4 space-y-4">
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentbUw} default="Pricing" onChange={ (newtext) =>  {
        setAttributes({ contentbUw: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentCvz} default="Documentation" onChange={ (newtext) =>  {
        setAttributes({ contentCvz: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentKHV} default="Guides" onChange={ (newtext) =>  {
        setAttributes({ contentKHV: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentjMo} default="API Status" onChange={ (newtext) =>  {
    ...
    /></span>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                 <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText tagName="span" value={attributes.contentTGn} default="Company" onChange={ (newtext) =>  {
        setAttributes({ contentTGn: newtext });
      }}
    /></h3>

                                <ul role="list" className="mt-4 space-y-4">
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentGqD} default="About" onChange={ (newtext) =>  {
        setAttributes({ contentGqD: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentmhF} default="Blog" onChange={ (newtext) =>  {
        setAttributes({ contentmhF: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentKpq} default="Jobs" onChange={ (newtext) =>  {
        setAttributes({ contentKpq: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentNCf} default="Press" onChange={ (newtext) =>  {
        setAttributes({ contentNCf: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentRqJ} default="Partners" onChange={ (newtext) =>  {
        setAttributes({ contentRqJ: newtext });
      }}
    /></span>
                            ...
                            <div className="mt-12 md:mt-0">
                                 <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText tagName="span" value={attributes.contentgTJ} default="Legal" onChange={ (newtext) =>  {
        setAttributes({ contentgTJ: newtext });
      }}
    /></h3>

                                <ul role="list" className="mt-4 space-y-4">
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentlSP} default="Claim" onChange={ (newtext) =>  {
        setAttributes({ contentlSP: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentKEG} default="Privacy" onChange={ (newtext) =>  {
        setAttributes({ contentKEG: newtext });
      }}
    /></span>

                                    </li>
                                    <li> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentJKG} default="Terms" onChange={ (newtext) =>  {
    ...
    /></span>
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-400 xl:text-center">
                        <RichText tagName="span" value={attributes.contentxBX} default="&copy; 2020 Workflow, Inc. All rights reserved." onChange={ (newtext) => { setAttributes({ contentxBX: newtext }); }} /></p>
                </div>
            </div>
        </footer>
    </div>
    ...
    <div>
        <footer class="bg-white" aria-labelledby="footer-heading">
             <h2 id="footer-heading" class="sr-only"><RichText.Content value={attributes.contentBqq} /></h2>
      ...
      <img
          ...
          />
                        <p class="text-gray-500 text-base">
                            <RichText.Content value={attributes.contentZno} /></p>
                        <div class="flex space-x-6"> <span class="text-gray-400 hover:text-gray-500">
            <span class="sr-only"><RichText.Content value={attributes.contentvwq} /></span>
      ...
      <svg
        ...
        >
            ...
            <span class="sr-only"><RichText.Content value={attributes.contentQAW} /></span>
      ...
      <svg
        ...
        >
            ...
            <span class="sr-only"><RichText.Content value={attributes.contentyal} /></span>
      ...
      <svg
        ...
        >
            ...
            <span class="sr-only"><RichText.Content value={attributes.contentceH} /></span>
      ...
      <svg
        ...
        >
            ...
            <span class="sr-only"><RichText.Content value={attributes.contentJuq} /></span>
        ...
        >
                    ...
                    <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                 <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText.Content value={attributes.contentpTJ} /></h3>

                                <ul role="list" class="mt-4 space-y-4">
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentItq} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentAkd} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentand} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentOFX} /></span>

                                    </li>
                                </ul>
                            </div>
                            <div class="mt-12 md:mt-0">
                                 <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText.Content value={attributes.contentPpD} /></h3>

                                <ul role="list" class="mt-4 space-y-4">
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentbUw} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentCvz} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentKHV} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentjMo} /></span>
                        ...
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                 <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText.Content value={attributes.contentTGn} /></h3>

                                <ul role="list" class="mt-4 space-y-4">
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentGqD} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentmhF} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentKpq} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentNCf} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentRqJ} /></span>

                                    </li>
                                </ul>
                            </div>
                            <div class="mt-12 md:mt-0">
                                 <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase"><RichText.Content value={attributes.contentgTJ} /></h3>

                                <ul role="list" class="mt-4 space-y-4">
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentlSP} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentKEG} /></span>

                                    </li>
                                    <li> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentJKG} /></span>
                ...
                <div class="mt-12 border-t border-gray-200 pt-8">
                    <p class="text-base text-gray-400 xl:text-center">
                        <RichText.Content value={attributes.contentxBX} /></p>
                </div>
            </div>
        </footer>
    </div>
