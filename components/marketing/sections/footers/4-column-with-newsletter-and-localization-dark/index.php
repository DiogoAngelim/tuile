    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncdfX_4_column_with_newsletter_and_localization_darkfuncQDW_editor_assets' );

      function wpfuncdfX_4_column_with_newsletter_and_localization_darkfuncQDW_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncdfX_4_column_with_newsletter_and_localization_darkfuncQDW_block_assets' );

    function wpfuncdfX_4_column_with_newsletter_and_localization_darkfuncQDW_block_assets() {
      $args = array(
