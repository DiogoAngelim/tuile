  ...
  "svgnVs": {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svggMi }
            onChange={ ( value ) => {
              setAttributes({ svggMi: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svggFV }
            onChange={ ( value ) => {
              setAttributes({ svggFV: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgyPW }
            onChange={ ( value ) => {
              setAttributes({ svgyPW: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgWes }
            onChange={ ( value ) => {
              setAttributes({ svgWes: value });
            } }
          />
        </div>
      </PanelRow>
        ...
        <footer className="bg-white">
            <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
                    <div className="px-5 py-2"> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentmMX} default="About" onChange={ (newtext) =>  {
        setAttributes({ contentmMX: newtext });
      }}
    /></span>

                    </div>
                    <div className="px-5 py-2"> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contenttnV} default="Blog" onChange={ (newtext) =>  {
        setAttributes({ contenttnV: newtext });
      }}
    /></span>

                    </div>
                    <div className="px-5 py-2"> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentBbN} default="Jobs" onChange={ (newtext) =>  {
        setAttributes({ contentBbN: newtext });
      }}
    /></span>

                    </div>
                    <div className="px-5 py-2"> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentQrl} default="Press" onChange={ (newtext) =>  {
        setAttributes({ contentQrl: newtext });
      }}
    /></span>

                    </div>
                    <div className="px-5 py-2"> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentrqB} default="Accessibility" onChange={ (newtext) =>  {
        setAttributes({ contentrqB: newtext });
      }}
    /></span>

                    </div>
                    <div className="px-5 py-2"> <span className="text-base text-gray-500 hover:text-gray-900"><RichText tagName="span" value={attributes.contentbpT} default="Partners" onChange={ (newtext) =>  {
    ...
    /></span>
        ...
        <span className="sr-only"><RichText tagName="span" value={attributes.contentElp} default="Facebook" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svggMi }}
        >
      </svg>
      
                    </span> <span className="text-gray-400 hover:text-gray-500">
        <span className="sr-only"><RichText tagName="span" value={attributes.contentpHm} default="Instagram" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svggFV }}
        >
      </svg>
      
                    </span> <span className="text-gray-400 hover:text-gray-500">
        <span className="sr-only"><RichText tagName="span" value={attributes.contentLqv} default="Twitter" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgyPW }}
        >
      </svg>
      
                    </span> <span className="text-gray-400 hover:text-gray-500">
        <span className="sr-only"><RichText tagName="span" value={attributes.contentKIr} default="GitHub" onChange={ (newtext) =>  {
        setAttributes({ contentKIr: newtext });
      }}
    /></span>
      ...
      <svg
         className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgWes }}
        >
      </svg>
      
                    </span> <span className="text-gray-400 hover:text-gray-500">
        <span className="sr-only"><RichText tagName="span" value={attributes.contentpVl} default="Dribbble" onChange={ (newtext) =>  {
      ...
      <svg
        ...
        >
                ...
                <p className="mt-8 text-center text-base text-gray-400">
                    <RichText tagName="span" value={attributes.contentAxi} default="&copy; 2020 Workflow, Inc. All rights reserved." onChange={ (newtext) => { setAttributes({ contentAxi: newtext }); }} /></p>
            </div>
        </footer>
    </div>
</div>
    ...
    <div>
        <footer class="bg-white">
            <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
                    <div class="px-5 py-2"> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentmMX} /></span>

                    </div>
                    <div class="px-5 py-2"> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contenttnV} /></span>

                    </div>
                    <div class="px-5 py-2"> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentBbN} /></span>

                    </div>
                    <div class="px-5 py-2"> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentQrl} /></span>

                    </div>
                    <div class="px-5 py-2"> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentrqB} /></span>

                    </div>
                    <div class="px-5 py-2"> <span class="text-base text-gray-500 hover:text-gray-900"><RichText.Content value={attributes.contentbpT} /></span>

                    </div>
                </nav>
                <div class="mt-8 flex justify-center space-x-6"> <span class="text-gray-400 hover:text-gray-500">
        <span class="sr-only"><RichText.Content value={attributes.contentElp} /></span>
      ...
      <svg
        ...
        <span class="sr-only"><RichText.Content value={attributes.contentpHm} /></span>
      ...
      <svg
        ...
        <span class="sr-only"><RichText.Content value={attributes.contentLqv} /></span>
      ...
      <svg
        ...
        <span class="sr-only"><RichText.Content value={attributes.contentKIr} /></span>
      ...
      <svg
        ...
        <span class="sr-only"><RichText.Content value={attributes.contentpVl} /></span>
      ...
      <svg
        ...
        >
                ...
                <p class="mt-8 text-center text-base text-gray-400">
                    <RichText.Content value={attributes.contentAxi} /></p>
            </div>
        </footer>
    </div>
</div>
