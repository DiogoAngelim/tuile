            ...
            <div className="max-w-7xl mx-auto py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-24">
                <div className="space-y-8 sm:space-y-12">
                    <div className="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
                         <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl"><RichText tagName="span" value={attributes.contentYhL} default="The People" onChange={ (newtext) =>  {
        setAttributes({ contentYhL: newtext });
      }}
    /></h2>

                        <p className="text-xl text-gray-500">
                            <RichText tagName="span" value={attributes.contentQoN} default="Risus velit condimentum vitae tincidunt tincidunt. Mauris ridiculus fusce amet urna nunc. Ut nisl ornare diam in." onChange={ (newtext) => { setAttributes({ contentQoN: newtext }); }} /></p>
                    </div>
      ...
      <MediaUpload 
        onSelect={ (media) => { 
          setAttributes({ 
            imageurlKlv: media.url,
            imagealtTyu: media.alt
          }); 
        } }
        type="image" 
        render={ ({ open }) => (
          <img
            src={ attributes.imageurlKlv } 
            alt={ attributes.imagealtTyu } 
            onClick={ open } 
      ...
      />
                                <div className="space-y-2">
                                    <div className="text-xs font-medium lg:text-sm">
                                         <h3><RichText tagName="span" value={attributes.contentjdB} default="Michael Foster" onChange={ (newtext) =>  {
        setAttributes({ contentjdB: newtext });
      }}
    /></h3>

                                        <p className="text-indigo-600">
                                            <RichText tagName="span" value={attributes.contentThb} default="Co-Founder / CTO" onChange={ (newtext) => { setAttributes({ contentThb: newtext }); }} /></p>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-24">
                <div class="space-y-8 sm:space-y-12">
                    <div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
                         <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl"><RichText.Content value={attributes.contentYhL} /></h2>

                        <p class="text-xl text-gray-500">
                            <RichText.Content value={attributes.contentQoN} /></p>
                    </div>
          ...
          />
                                <div class="space-y-2">
                                    <div class="text-xs font-medium lg:text-sm">
                                         <h3><RichText.Content value={attributes.contentjdB} /></h3>

                                        <p class="text-indigo-600">
                                            <RichText.Content value={attributes.contentThb} /></p>
                                    </div>
                                </div>
                            </div>
                        </li>
