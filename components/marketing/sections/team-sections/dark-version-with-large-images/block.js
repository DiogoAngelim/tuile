      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgAdZ }
            onChange={ ( value ) => {
              setAttributes({ svgAdZ: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgYiH }
            onChange={ ( value ) => {
              setAttributes({ svgYiH: value });
            } }
          />
        </div>
      </PanelRow>
            ...
            <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                <div className="space-y-12">
                    <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                         <h2 className="text-3xl font-extrabold text-white tracking-tight sm:text-4xl"><RichText tagName="span" value={attributes.contentCEf} default="Meet our team" onChange={ (newtext) =>  {
        setAttributes({ contentCEf: newtext });
      }}
    /></h2>

                        <p className="text-xl text-gray-300">
                            <RichText tagName="span" value={attributes.contentsWm} default="Ornare sagittis, suspendisse in hendrerit quis. Sed dui aliquet lectus sit pretium egestas vel mattis neque." onChange={ (newtext) => { setAttributes({ contentsWm: newtext }); }} /></p>
                    </div>
      ...
      <MediaUpload 
        onSelect={ (media) => { 
          setAttributes({ 
            imageurlkBk: media.url,
            imagealtknV: media.alt
          }); 
        } }
        type="image" 
        render={ ({ open }) => (
          <img
            src={ attributes.imageurlkBk } 
            alt={ attributes.imagealtknV } 
            onClick={ open } 
      ...
      />
                                <div className="space-y-2 xl:flex xl:items-center xl:justify-between">
                                    <div className="font-medium text-lg leading-6 space-y-1">
                                         <h3 className="text-white"><RichText tagName="span" value={attributes.contentvNA} default="Leonard Krasner" onChange={ (newtext) =>  {
        setAttributes({ contentvNA: newtext });
      }}
    /></h3>

                                        <p className="text-indigo-400">
                                            <RichText tagName="span" value={attributes.contentLTs} default="Senior Designer" onChange={ (newtext) => { setAttributes({ contentLTs: newtext }); }} /></p>
                                    </div>
                                    <ul role="list" className="flex justify-center space-x-5">
                                        <li> <span className="text-gray-400 hover:text-gray-300">
                    <span className="sr-only"><RichText tagName="span" value={attributes.contentyXa} default="Twitter" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgAdZ }}
        >
      </svg>
                                        ...
                                        <li> <span className="text-gray-400 hover:text-gray-300">
                    <span className="sr-only"><RichText tagName="span" value={attributes.contentzTv} default="LinkedIn" onChange={ (newtext) =>  {
        setAttributes({ contentzTv: newtext });
      }}
    /></span>
      ...
      <svg
         className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgYiH }}
        >
      </svg>
    ...
    <div>
            ...
            <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                <div class="space-y-12">
                    <div class="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                         <h2 class="text-3xl font-extrabold text-white tracking-tight sm:text-4xl"><RichText.Content value={attributes.contentCEf} /></h2>

                        <p class="text-xl text-gray-300">
                            <RichText.Content value={attributes.contentsWm} /></p>
                    </div>
          ...
          />
                                <div class="space-y-2 xl:flex xl:items-center xl:justify-between">
                                    <div class="font-medium text-lg leading-6 space-y-1">
                                         <h3 class="text-white"><RichText.Content value={attributes.contentvNA} /></h3>

                                        <p class="text-indigo-400">
                                            <RichText.Content value={attributes.contentLTs} /></p>
                                    </div>
                                    <ul role="list" class="flex justify-center space-x-5">
                                        <li> <span class="text-gray-400 hover:text-gray-300">
                    <span class="sr-only"><RichText.Content value={attributes.contentyXa} /></span>
      ...
      <svg
        ...
        >
                                        ...
                                        <li> <span class="text-gray-400 hover:text-gray-300">
                    <span class="sr-only"><RichText.Content value={attributes.contentzTv} /></span>
