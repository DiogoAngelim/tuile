    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncuFR_with_image_and_short_paragraphfuncjWu_editor_assets' );

      function wpfuncuFR_with_image_and_short_paragraphfuncjWu_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncuFR_with_image_and_short_paragraphfuncjWu_block_assets' );

    function wpfuncuFR_with_image_and_short_paragraphfuncjWu_block_assets() {
      $args = array(
