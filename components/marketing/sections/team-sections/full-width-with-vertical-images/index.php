    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncYKT_full_width_with_vertical_imagesfuncGnW_editor_assets' );

      function wpfuncYKT_full_width_with_vertical_imagesfuncGnW_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncYKT_full_width_with_vertical_imagesfuncGnW_block_assets' );

    function wpfuncYKT_full_width_with_vertical_imagesfuncGnW_block_assets() {
      $args = array(
