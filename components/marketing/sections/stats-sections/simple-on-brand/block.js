        ...
        <div className="bg-indigo-800">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="max-w-4xl mx-auto text-center">
                     <h2 className="text-3xl font-extrabold text-white sm:text-4xl"><RichText tagName="span" value={attributes.contentgTe} default="Trusted by developers from over 80 planets" onChange={ (newtext) =>  {
        setAttributes({ contentgTe: newtext });
      }}
    /></h2>

                    <p className="mt-3 text-xl text-indigo-200 sm:mt-4">
                        <RichText tagName="span" value={attributes.contenttHp} default="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repellendus repellat laudantium." onChange={ (newtext) => { setAttributes({ contenttHp: newtext }); }} /></p>
                </div>
                <dl className="mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
                    <div className="flex flex-col"> <dt className="order-2 mt-2 text-lg leading-6 font-medium text-indigo-200"><RichText tagName="span" value={attributes.contentaJO} default="Pepperoni" onChange={ (newtext) =>  {
        setAttributes({ contentaJO: newtext });
      }}
    /></dt>

                        <dd className="order-1 text-5xl font-extrabold text-white">
                            <RichText tagName="span" value={attributes.contentnfY} default="100%" onChange={ (newtext) => { setAttributes({ contentnfY: newtext }); }} /></dd>
                    </div>
                    <div className="flex flex-col mt-10 sm:mt-0"> <dt className="order-2 mt-2 text-lg leading-6 font-medium text-indigo-200"><RichText tagName="span" value={attributes.contentqzH} default="Delivery" onChange={ (newtext) =>  {
        setAttributes({ contentqzH: newtext });
      }}
    /></dt>

                        <dd className="order-1 text-5xl font-extrabold text-white">
                            <RichText tagName="span" value={attributes.contentyZm} default="24/7" onChange={ (newtext) => { setAttributes({ contentyZm: newtext }); }} /></dd>
                    </div>
                    <div className="flex flex-col mt-10 sm:mt-0"> <dt className="order-2 mt-2 text-lg leading-6 font-medium text-indigo-200"><RichText tagName="span" value={attributes.contentlXi} default="Calories" onChange={ (newtext) =>  {
        setAttributes({ contentlXi: newtext });
      }}
    /></dt>

                        <dd className="order-1 text-5xl font-extrabold text-white">
                            <RichText tagName="span" value={attributes.contentaII} default="100k+" onChange={ (newtext) => { setAttributes({ contentaII: newtext }); }} /></dd>
                    </div>
                </dl>
            </div>
        </div>
        ...
        <div class="bg-indigo-800">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
                <div class="max-w-4xl mx-auto text-center">
                     <h2 class="text-3xl font-extrabold text-white sm:text-4xl"><RichText.Content value={attributes.contentgTe} /></h2>

                    <p class="mt-3 text-xl text-indigo-200 sm:mt-4">
                        <RichText.Content value={attributes.contenttHp} /></p>
                </div>
                <dl class="mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
                    <div class="flex flex-col"> <dt class="order-2 mt-2 text-lg leading-6 font-medium text-indigo-200"><RichText.Content value={attributes.contentaJO} /></dt>

                        <dd class="order-1 text-5xl font-extrabold text-white">
                            <RichText.Content value={attributes.contentnfY} /></dd>
                    </div>
                    <div class="flex flex-col mt-10 sm:mt-0"> <dt class="order-2 mt-2 text-lg leading-6 font-medium text-indigo-200"><RichText.Content value={attributes.contentqzH} /></dt>

                        <dd class="order-1 text-5xl font-extrabold text-white">
                            <RichText.Content value={attributes.contentyZm} /></dd>
                    </div>
                    <div class="flex flex-col mt-10 sm:mt-0"> <dt class="order-2 mt-2 text-lg leading-6 font-medium text-indigo-200"><RichText.Content value={attributes.contentlXi} /></dt>

                        <dd class="order-1 text-5xl font-extrabold text-white">
                            <RichText.Content value={attributes.contentaII} /></dd>
                    </div>
                </dl>
            </div>
        </div>
