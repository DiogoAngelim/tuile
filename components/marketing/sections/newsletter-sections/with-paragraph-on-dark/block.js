        ...
        <div className="bg-gray-800">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
                <div className="lg:w-0 lg:flex-1">
                     <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl" id="newsletter-headline"><RichText tagName="span" value={attributes.contentkTx} default="Sign up for our newsletter" onChange={ (newtext) =>  {
        setAttributes({ contentkTx: newtext });
      }}
    /></h2>

                    <p className="mt-3 max-w-3xl text-lg leading-6 text-gray-300">
                        <RichText tagName="span" value={attributes.contentgfS} default="Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui Lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat." onChange={ (newtext) => { setAttributes({ contentgfS: newtext }); }} /></p>
                </div>
                <div className="mt-8 lg:mt-0 lg:ml-8">
                    <form className="sm:flex">
                        <label for="email-address" className="sr-only">
                            <RichText tagName="span" value={attributes.contentJoz} default="Email address" onChange={ (newtext) => { setAttributes({ contentJoz: newtext }); }} /></label>
                        ...
                        <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                            <button type="submit" className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500">
                                <RichText tagName="span" value={attributes.contentuVi} default="Notify me" onChange={ (newtext) => { setAttributes({ contentuVi: newtext }); }} /></button>
                        </div>
                    </form>
                    <p className="mt-3 text-sm text-gray-300">
                        <RichText tagName="span" value={attributes.contentUeT} default="We care about the protection of your data. Read our" onChange={ (newtext) => { setAttributes({ contentUeT: newtext }); }} /><span className="text-white font-medium underline"><RichText tagName="span" value={attributes.contentcOc} default="Privacy Policy." onChange={ (newtext) =>  {
        setAttributes({ contentcOc: newtext });
      }}
    /></span>
        ...
        <div class="bg-gray-800">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
                <div class="lg:w-0 lg:flex-1">
                     <h2 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl" id="newsletter-headline"><RichText.Content value={attributes.contentkTx} /></h2>

                    <p class="mt-3 max-w-3xl text-lg leading-6 text-gray-300">
                        <RichText.Content value={attributes.contentgfS} /></p>
                </div>
                <div class="mt-8 lg:mt-0 lg:ml-8">
                    <form class="sm:flex">
                        <label for="email-address" class="sr-only">
                            <RichText.Content value={attributes.contentJoz} /></label>
                    ...
                    <p class="mt-3 text-sm text-gray-300">
                        <RichText.Content value={attributes.contentUeT} /><span class="text-white font-medium underline"><RichText.Content value={attributes.contentcOc} /></span>
