            ...
            <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
                <div className="px-6 py-6 bg-indigo-700 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
                    <div className="xl:w-0 xl:flex-1">
                         <h2 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl"><RichText tagName="span" value={attributes.contentezv} default="Want product news and updates?" onChange={ (newtext) =>  {
        setAttributes({ contentezv: newtext });
      }}
    /></h2>

                        <p className="mt-3 max-w-3xl text-lg leading-6 text-indigo-200">
                            <RichText tagName="span" value={attributes.contentKmE} default="Sign up for our newsletter to stay up to date." onChange={ (newtext) => { setAttributes({ contentKmE: newtext }); }} /></p>
                    </div>
                    <div className="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                        <form className="sm:flex">
                            <label for="email-address" className="sr-only">
                                <RichText tagName="span" value={attributes.contentOIs} default="Email address" onChange={ (newtext) => { setAttributes({ contentOIs: newtext }); }} /></label>
                            ...
                            <button type="submit" className="mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0">
                                <RichText tagName="span" value={attributes.contentENt} default="Notify me" onChange={ (newtext) => { setAttributes({ contentENt: newtext }); }} /></button>
                        </form>
                        <p className="mt-3 text-sm text-indigo-200">
                            <RichText tagName="span" value={attributes.contentbDd} default="We care about the protection of your data. Read our" onChange={ (newtext) => { setAttributes({ contentbDd: newtext }); }} /><span className="text-white font-medium underline"><RichText tagName="span" value={attributes.contentkJw} default="Privacy Policy." onChange={ (newtext) =>  {
        setAttributes({ contentkJw: newtext });
      }}
    /></span>
            ...
            <div class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
                <div class="px-6 py-6 bg-indigo-700 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
                    <div class="xl:w-0 xl:flex-1">
                         <h2 class="text-2xl font-extrabold tracking-tight text-white sm:text-3xl"><RichText.Content value={attributes.contentezv} /></h2>

                        <p class="mt-3 max-w-3xl text-lg leading-6 text-indigo-200">
                            <RichText.Content value={attributes.contentKmE} /></p>
                    </div>
                    <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                        <form class="sm:flex">
                            <label for="email-address" class="sr-only">
                                <RichText.Content value={attributes.contentOIs} /></label>
                            ...
                            <button type="submit" class="mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0">
                                <RichText.Content value={attributes.contentENt} /></button>
                        </form>
                        <p class="mt-3 text-sm text-indigo-200">
                            <RichText.Content value={attributes.contentbDd} /><span class="text-white font-medium underline"><RichText.Content value={attributes.contentkJw} /></span>
