    ...
    <div>
        <div className="bg-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                 <h2 className="inline text-3xl font-extrabold tracking-tight text-gray-900 sm:block sm:text-4xl"><RichText tagName="span" value={attributes.contentWVk} default="Want product news and updates?" onChange={ (newtext) =>  {
        setAttributes({ contentWVk: newtext });
      }}
    /></h2>

                <p className="inline text-3xl font-extrabold tracking-tight text-indigo-600 sm:block sm:text-4xl">
                    <RichText tagName="span" value={attributes.contentcjH} default="Sign up for our newsletter." onChange={ (newtext) => { setAttributes({ contentcjH: newtext }); }} /></p>
                <form className="mt-8 sm:flex">
                    <label for="email-address" className="sr-only">
                        <RichText tagName="span" value={attributes.contentDnw} default="Email address" onChange={ (newtext) => { setAttributes({ contentDnw: newtext }); }} /></label>
                    ...
                    <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                        <button type="submit" className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <RichText tagName="span" value={attributes.contentrKq} default="Notify me" onChange={ (newtext) => { setAttributes({ contentrKq: newtext }); }} /></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div>
        <div class="bg-white">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                 <h2 class="inline text-3xl font-extrabold tracking-tight text-gray-900 sm:block sm:text-4xl"><RichText.Content value={attributes.contentWVk} /></h2>

                <p class="inline text-3xl font-extrabold tracking-tight text-indigo-600 sm:block sm:text-4xl">
                    <RichText.Content value={attributes.contentcjH} /></p>
                <form class="mt-8 sm:flex">
                    <label for="email-address" class="sr-only">
                        <RichText.Content value={attributes.contentDnw} /></label>
                    ...
                    <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                        <button type="submit" class="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <RichText.Content value={attributes.contentrKq} /></button>
                    </div>
                </form>
            </div>
        </div>
