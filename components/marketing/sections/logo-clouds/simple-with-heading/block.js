  ...
  "imagealtyrH": {
        ...
        <div className="bg-indigo-200 bg-opacity-25">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                     <h2 className="max-w-md mx-auto text-3xl font-extrabold text-indigo-900 text-center lg:max-w-xl lg:text-left"><RichText tagName="span" value={attributes.contentuHq} default="The world's most innovative companies use Workflow" onChange={ (newtext) =>  {
    ...
    /></h2>
      ...
      <MediaUpload 
        onSelect={ (media) => { 
          setAttributes({ 
            imageurlhfu: media.url,
            imagealtcie: media.alt
          }); 
        } }
        type="image" 
        render={ ({ open }) => (
          <img
            src={ attributes.imageurlhfu } 
            alt={ attributes.imagealtcie } 
            onClick={ open } 
            className="h-12"
          /> 
        )} 
      ...
      <MediaUpload 
        onSelect={ (media) => { 
          setAttributes({ 
            imageurlNvS: media.url,
            imagealtyrH: media.alt
          }); 
        } }
        type="image" 
        render={ ({ open }) => (
          <img
            src={ attributes.imageurlNvS } 
            alt={ attributes.imagealtyrH } 
            onClick={ open } 
            className="h-12"
          /> 
        )} 
        ...
        <div class="bg-indigo-200 bg-opacity-25">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                     <h2 class="max-w-md mx-auto text-3xl font-extrabold text-indigo-900 text-center lg:max-w-xl lg:text-left"><RichText.Content value={attributes.contentuHq} /></h2>
