    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncgyV_single_price_with_detailsfuncneX_editor_assets' );

      function wpfuncgyV_single_price_with_detailsfuncneX_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncgyV_single_price_with_detailsfuncneX_block_assets' );

    function wpfuncgyV_single_price_with_detailsfuncneX_block_assets() {
      $args = array(
