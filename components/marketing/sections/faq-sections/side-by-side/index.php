    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncdRP_side_by_sidefuncLCG_editor_assets' );
      ...
      wp_localize_script( 'wp-side-by-side', 'vars', array( 'url' => plugin_dir_url( __FILE__ ) ) );

      $filepath = plugin_dir_path(__FILE__) . 'editor.css';
      $version = file_exists($filepath) ? filemtime($filepath) : time();

      wp_enqueue_style(
        'wp-side-by-side-editor',
    ...
    function wpfuncdRP_side_by_sidefuncLCG_block_assets() {
      ...
      wp_localize_script( 'wp-side-by-side-js', 'vars', array( 'url' => plugin_dir_url( __FILE__ ) ) );
    }
