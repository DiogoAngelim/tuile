  ...
  "svgkVu": {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgkVu }
            onChange={ ( value ) => {
              setAttributes({ svgkVu: value });
            } }
          />
        </div>
      </PanelRow>
        ...
        <div className="bg-gray-50">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto divide-y-2 divide-gray-200">
                     <h2 className="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl"><RichText tagName="span" value={attributes.contentDtj} default="Frequently asked questions" onChange={ (newtext) =>  {
    ...
    /></h2>
            ...
            <button type="button" className="text-left w-full flex justify-between items-start text-gray-400" aria-controls="faq-0" aria-expanded="false">
              <span className="font-medium text-gray-900"><RichText tagName="span" value={attributes.contentHGJ} default="What&#039;s the best thing about Switzerland?" onChange={ (newtext) =>  {
        setAttributes({ contentHGJ: newtext });
      }}
    /></span>
      ...
      <svg
         className="rotate-0 h-6 w-6 transform" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgkVu }}
        >
      </svg>
                            ...
                            <dd className="mt-2 pr-12" id="faq-0">
                                <p className="text-base text-gray-500">
                                    <RichText tagName="span" value={attributes.contentZaE} default="I don&#039;t know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat." onChange={ (newtext) => { setAttributes({ contentZaE: newtext }); }} /></p>
                            </dd>
                        </div>
                    </dl>
                </div>
        ...
        <div class="bg-gray-50">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto divide-y-2 divide-gray-200">
                     <h2 class="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl"><RichText.Content value={attributes.contentDtj} /></h2>
            ...
            <button type="button" class="text-left w-full flex justify-between items-start text-gray-400" aria-controls="faq-0" aria-expanded="false">
              <span class="font-medium text-gray-900"><RichText.Content value={attributes.contentHGJ} /></span>
        ...
        >
                            ...
                            <dd class="mt-2 pr-12" id="faq-0">
                                <p class="text-base text-gray-500">
                                    <RichText.Content value={attributes.contentZaE} /></p>
                            </dd>
                        </div>
                    </dl>
                </div>
