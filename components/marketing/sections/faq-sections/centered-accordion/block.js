  ...
  const { Panel, PanelBody, PanelRow, TextareaControl } = wp.components;
        ...
        registerBlockType('wp/centered-accordion', {
  ...
  "svgSPl": {
    "type": "string",
    "default": "<path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M19 9l-7 7-7-7\"/>"
  }
},
            edit(props) {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgSPl }
            onChange={ ( value ) => {
              setAttributes({ svgSPl: value });
            } }
          />
        </div>
      </PanelRow>
        ...
        <div className="bg-gray-50">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto divide-y-2 divide-gray-200">
                     <h2 className="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl"><RichText tagName="span" value={attributes.contentgln} default="Frequently asked questions" onChange={ (newtext) =>  {
        setAttributes({ contentgln: newtext });
      }}
    /></h2>

                    <dl className="mt-6 space-y-6 divide-y divide-gray-200">
                        <div className="pt-6"> <dt className="text-lg">
            ...
            <button type="button" className="text-left w-full flex justify-between items-start text-gray-400" aria-controls="faq-0" aria-expanded="false">
              <span className="font-medium text-gray-900"><RichText tagName="span" value={attributes.contentnkf} default="What&#039;s the best thing about Switzerland?" onChange={ (newtext) =>  {
        setAttributes({ contentnkf: newtext });
      }}
    /></span>
      ...
      <svg
         className="rotate-0 h-6 w-6 transform" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgSPl }}
        >
      </svg>
                            ...
                            <dd className="mt-2 pr-12" id="faq-0">
                                <p className="text-base text-gray-500">
                                    <RichText tagName="span" value={attributes.contentNQn} default="I don&#039;t know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat." onChange={ (newtext) => { setAttributes({ contentNQn: newtext }); }} /></p>
                            </dd>
                        </div>
                    </dl>
                </div>
        ...
        <div class="bg-gray-50">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto divide-y-2 divide-gray-200">
                     <h2 class="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl"><RichText.Content value={attributes.contentgln} /></h2>

                    <dl class="mt-6 space-y-6 divide-y divide-gray-200">
                        <div class="pt-6"> <dt class="text-lg">
            ...
            <button type="button" class="text-left w-full flex justify-between items-start text-gray-400" aria-controls="faq-0" aria-expanded="false">
              <span class="font-medium text-gray-900"><RichText.Content value={attributes.contentnkf} /></span>
              <span class="ml-6 h-7 flex items-center">
                
                
      <svg
         class="rotate-0 h-6 w-6 transform" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgSPl }}
        >
      </svg>
                            ...
                            <dd class="mt-2 pr-12" id="faq-0">
                                <p class="text-base text-gray-500">
                                    <RichText.Content value={attributes.contentNQn} /></p>
                            </dd>
                        </div>
                    </dl>
                </div>
