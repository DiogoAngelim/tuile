  ...
  const { Panel, PanelBody, PanelRow, TextareaControl } = wp.components;
        ...
        registerBlockType('wp/two-columns-on-brand', {
    ...
    <div>
        <div className="bg-indigo-700">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                 <h2 className="text-3xl font-extrabold text-white"><RichText tagName="span" value={attributes.contentSLQ} default="Frequently asked questions" onChange={ (newtext) =>  {
    ...
    /></h2>
                ...
                <div className="mt-6 border-t border-indigo-300 border-opacity-25 pt-10">
                    <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-12">
                        <div> <dt className="text-lg leading-6 font-medium text-white"><RichText tagName="span" value={attributes.contentldQ} default="What&#039;s the best thing about Switzerland?" onChange={ (newtext) =>  {
        setAttributes({ contentldQ: newtext });
      }}
    /></dt>

                            <dd className="mt-2 text-base text-indigo-200">
                                <RichText tagName="span" value={attributes.contentQQY} default="I don&#039;t know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat." onChange={ (newtext) => { setAttributes({ contentQQY: newtext }); }} /></dd>
                        </div>
                    </dl>
                </div>
            </div>
    ...
    <div>
        <div class="bg-indigo-700">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                 <h2 class="text-3xl font-extrabold text-white"><RichText.Content value={attributes.contentSLQ} /></h2>
                ...
                <div class="mt-6 border-t border-indigo-300 border-opacity-25 pt-10">
                    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-12">
                        <div> <dt class="text-lg leading-6 font-medium text-white"><RichText.Content value={attributes.contentldQ} /></dt>

                            <dd class="mt-2 text-base text-indigo-200">
                                <RichText.Content value={attributes.contentQQY} /></dd>
                        </div>
                    </dl>
                </div>
            </div>
