    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncood_with_app_screenshotfunctCG_editor_assets' );

      function wpfuncood_with_app_screenshotfunctCG_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncood_with_app_screenshotfunctCG_block_assets' );

    function wpfuncood_with_app_screenshotfunctCG_block_assets() {
      $args = array(
