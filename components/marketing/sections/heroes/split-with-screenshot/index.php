    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncHcx_split_with_screenshotfuncwsG_editor_assets' );

      function wpfuncHcx_split_with_screenshotfuncwsG_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncHcx_split_with_screenshotfuncwsG_block_assets' );

    function wpfuncHcx_split_with_screenshotfuncwsG_block_assets() {
      $args = array(
