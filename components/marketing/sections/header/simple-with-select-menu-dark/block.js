      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svghyJ }
            onChange={ ( value ) => {
              setAttributes({ svghyJ: value });
            } }
          />
        </div>
      </PanelRow>
        ...
        <div className="bg-gray-800">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:flex lg:justify-between">
                <div className="max-w-xl">
                     <h2 className="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl"><RichText tagName="span" value={attributes.contentybo} default="Pricing Plans" onChange={ (newtext) =>  {
        setAttributes({ contentybo: newtext });
      }}
    /></h2>

                    <p className="mt-5 text-xl text-gray-400">
                        <RichText tagName="span" value={attributes.contentjZL} default="Start building for free, then add a site plan to go live. Account plans unlock additional features." onChange={ (newtext) => { setAttributes({ contentjZL: newtext }); }} /></p>
                </div>
                <div className="mt-10 w-full max-w-xs">
                    <label for="currency" className="block text-base font-medium text-gray-300">
                        <RichText tagName="span" value={attributes.contentudb} default="Currency" onChange={ (newtext) => { setAttributes({ contentudb: newtext }); }} /></label>
                    <div className="mt-1.5 relative">
                        <select id="currency" name="currency" className="appearance-none block w-full bg-none bg-gray-700 border border-transparent rounded-md pl-3 pr-10 py-2 text-base text-white focus:outline-none focus:ring-1 focus:ring-white focus:border-white sm:text-sm">
                            <option>
                                <RichText tagName="span" value={attributes.contentASZ} default="Argentina (ARS)" onChange={ (newtext) => { setAttributes({ contentASZ: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentwdj} default="Australia (AUD)" onChange={ (newtext) => { setAttributes({ contentwdj: newtext }); }} /></option>
                            <option selected="">
                                <RichText tagName="span" value={attributes.contentxbV} default="United States (USD)" onChange={ (newtext) => { setAttributes({ contentxbV: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentaHH} default="Canada (CAD)" onChange={ (newtext) => { setAttributes({ contentaHH: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentCYd} default="France (EUR)" onChange={ (newtext) => { setAttributes({ contentCYd: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentsGG} default="Japan (JPY)" onChange={ (newtext) => { setAttributes({ contentsGG: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentKzX} default="Nigeria (NGN)" onChange={ (newtext) => { setAttributes({ contentKzX: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentUTY} default="Switzerland (CHF)" onChange={ (newtext) => { setAttributes({ contentUTY: newtext }); }} /></option>
                            <option>
                                <RichText tagName="span" value={attributes.contentLKF} default="United Kingdom (GBP)" onChange={ (newtext) => { setAttributes({ contentLKF: newtext }); }} /></option>
                        </select>
      ...
      <svg
         className="h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svghyJ }}
        >
      </svg>
    ...
    <div>
        <div class="bg-gray-800">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:flex lg:justify-between">
                <div class="max-w-xl">
                     <h2 class="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl"><RichText.Content value={attributes.contentybo} /></h2>

                    <p class="mt-5 text-xl text-gray-400">
                        <RichText.Content value={attributes.contentjZL} /></p>
                </div>
                <div class="mt-10 w-full max-w-xs">
                    <label for="currency" class="block text-base font-medium text-gray-300">
                        <RichText.Content value={attributes.contentudb} /></label>
                    <div class="mt-1.5 relative">
                        <select id="currency" name="currency" class="appearance-none block w-full bg-none bg-gray-700 border border-transparent rounded-md pl-3 pr-10 py-2 text-base text-white focus:outline-none focus:ring-1 focus:ring-white focus:border-white sm:text-sm">
                            <option>
                                <RichText.Content value={attributes.contentASZ} /></option>
                            <option>
                                <RichText.Content value={attributes.contentwdj} /></option>
                            <option selected="">
                                <RichText.Content value={attributes.contentxbV} /></option>
                            <option>
                                <RichText.Content value={attributes.contentaHH} /></option>
                            <option>
                                <RichText.Content value={attributes.contentCYd} /></option>
                            <option>
                                <RichText.Content value={attributes.contentsGG} /></option>
                            <option>
                                <RichText.Content value={attributes.contentKzX} /></option>
                            <option>
                                <RichText.Content value={attributes.contentUTY} /></option>
                            <option>
                                <RichText.Content value={attributes.contentLKF} /></option>
                        </select>
