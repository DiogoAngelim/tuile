    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncNez_with_background_imagefuncFOj_editor_assets' );

      function wpfuncNez_with_background_imagefuncFOj_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncNez_with_background_imagefuncFOj_block_assets' );

    function wpfuncNez_with_background_imagefuncFOj_block_assets() {
      $args = array(
