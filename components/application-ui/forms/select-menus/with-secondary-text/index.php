    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncXqj_with_secondary_textfuncuND_editor_assets' );

      function wpfuncXqj_with_secondary_textfuncuND_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncXqj_with_secondary_textfuncuND_block_assets' );

    function wpfuncXqj_with_secondary_textfuncuND_block_assets() {
      $args = array(
