    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncorh_list_with_inline_descriptionfuncWGX_editor_assets' );

      function wpfuncorh_list_with_inline_descriptionfuncWGX_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncorh_list_with_inline_descriptionfuncWGX_block_assets' );

    function wpfuncorh_list_with_inline_descriptionfuncWGX_block_assets() {
      $args = array(
