  ...
  const { Panel, PanelBody, PanelRow, TextareaControl } = wp.components;
        ...
        registerBlockType('wp/with-check-on-left', {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgFSy }
            onChange={ ( value ) => {
              setAttributes({ svgFSy: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgdDw }
            onChange={ ( value ) => {
              setAttributes({ svgdDw: value });
            } }
          />
        </div>
      </PanelRow>
    ...
    <div>
        <div>
            <label for="combobox" className="block text-sm font-medium text-gray-700">
                <RichText tagName="span" value={attributes.contentYJu} default="Assigned to" onChange={ (newtext) => { setAttributes({ contentYJu: newtext }); }} /></label>
      ...
      <svg
         className="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgFSy }}
        >
      </svg>
                ...
                <ul className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" id="options" role="listbox">
                    <li className="relative cursor-default select-none py-2 pl-8 pr-4 text-gray-900" id="option-0" role="option" tabindex="-1"> <span className="block truncate"><RichText tagName="span" value={attributes.contentPHX} default="Leslie Alexander" onChange={ (newtext) =>  {
 ...
 <span className="absolute inset-y-0 left-0 flex items-center pl-1.5 text-indigo-600">
      ...
      <svg
         className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgdDw }}
        >
      </svg>
    ...
    <div>
        <div>
            <label for="combobox" class="block text-sm font-medium text-gray-700">
                <RichText.Content value={attributes.contentYJu} /></label>
      ...
      <svg
        ...
        >
                ...
                <ul class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" id="options" role="listbox">
                    <li class="relative cursor-default select-none py-2 pl-8 pr-4 text-gray-900" id="option-0" role="option" tabindex="-1"> <span class="block truncate"><RichText.Content value={attributes.contentPHX} /></span>
