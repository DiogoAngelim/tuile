      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgIcG }
            onChange={ ( value ) => {
              setAttributes({ svgIcG: value });
            } }
          />
        </div>
      </PanelRow>
    ...
    <div>
        <div>
            <label for="combobox" className="block text-sm font-medium text-gray-700">
                <RichText tagName="span" value={attributes.contentjCl} default="Assigned to" onChange={ (newtext) => { setAttributes({ contentjCl: newtext }); }} /></label>
      ...
      <svg
         className="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgIcG }}
        >
      </svg>
                ...
                <ul className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" id="options" role="listbox">
                    <li className="relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900" id="option-0" role="option" tabindex="-1"> <span className="block truncate"><RichText tagName="span" value={attributes.contentXeZ} default="Leslie Alexander" onChange={ (newtext) =>  {
        setAttributes({ contentXeZ: newtext });
      }}
    /></span>
    ...
    <div>
        <div>
            <label for="combobox" class="block text-sm font-medium text-gray-700">
                <RichText.Content value={attributes.contentjCl} /></label>
      ...
      <svg
        ...
        >
                ...
                <ul class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" id="options" role="listbox">
                    <li class="relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900" id="option-0" role="option" tabindex="-1"> <span class="block truncate"><RichText.Content value={attributes.contentXeZ} /></span>
