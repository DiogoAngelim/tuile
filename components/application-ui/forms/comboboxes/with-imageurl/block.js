  ...
  const { Panel, PanelBody, PanelRow, TextareaControl } = wp.components;
        ...
        registerBlockType('wp/with-imageurl', {
            title: 'with imageurl',
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgIfa }
            onChange={ ( value ) => {
              setAttributes({ svgIfa: value });
            } }
          />
        </div>
      </PanelRow>
      ...
      <PanelRow>
        <div>
          <TextareaControl
            label="SVG Content"
            help="Enter your SVG content..."
            value={ attributes.svgKJN }
            onChange={ ( value ) => {
              setAttributes({ svgKJN: value });
            } }
          />
        </div>
      </PanelRow>
    ...
    <div>
        <div>
            <label for="combobox" className="block text-sm font-medium text-gray-700">
                <RichText tagName="span" value={attributes.contentUoZ} default="Assigned to" onChange={ (newtext) => { setAttributes({ contentUoZ: newtext }); }} /></label>
      ...
      <svg
         className="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgIfa }}
        >
      </svg>
      ...
      <MediaUpload 
        onSelect={ (media) => { 
          setAttributes({ 
            imageurldgG: media.url,
            imagealtNvP: media.alt
          }); 
        } }
        type="image" 
        render={ ({ open }) => (
          <img
            src={ attributes.imageurldgG } 
            alt={ attributes.imagealtNvP } 
            onClick={ open } 
            className="h-6 w-6 flex-shrink-0 rounded-full"
          /> 
        )} 
      /> <span className="ml-3 truncate"><RichText tagName="span" value={attributes.contentBTP} default="Leslie Alexander" onChange={ (newtext) =>  {
    ...
    /></span>
      ...
      <svg
         className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgKJN }}
        >
      </svg>
    ...
    <div>
        <div>
            <label for="combobox" class="block text-sm font-medium text-gray-700">
                <RichText.Content value={attributes.contentUoZ} /></label>
      ...
      <img
          ...
          /> <span class="ml-3 truncate"><RichText.Content value={attributes.contentBTP} /></span>
