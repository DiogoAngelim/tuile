    ...
    */
    ...
    add_action( 'enqueue_block_editor_assets', 'wpfuncVTT_with_secondary_navigationfuncOFc_editor_assets' );

      function wpfuncVTT_with_secondary_navigationfuncOFc_editor_assets() {
    ...
    add_action( 'enqueue_block_assets', 'wpfuncVTT_with_secondary_navigationfuncOFc_block_assets' );

    function wpfuncVTT_with_secondary_navigationfuncOFc_block_assets() {
      $args = array(
