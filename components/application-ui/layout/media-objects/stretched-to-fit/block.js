  ...
  const { Panel, PanelBody, PanelRow, TextareaControl } = wp.components;
        ...
        registerBlockType('wp/stretched-to-fit', {
  ...
  "svgHYy": {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgHYy }
            onChange={ ( value ) => {
              setAttributes({ svgHYy: value });
            } }
          />
        </div>
      </PanelRow>
    ...
    <div>
      ...
      <svg
         className="h-full w-16 border border-gray-300 bg-white text-gray-300" preserveAspectRatio="none" stroke="currentColor" fill="none" viewBox="0 0 200 200" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgHYy }}
        >
      </svg>
      
            </div>
            <div>
                 <h4 className="text-lg font-bold"><RichText tagName="span" value={attributes.contentbYM} default="Lorem ipsum" onChange={ (newtext) =>  {
        setAttributes({ contentbYM: newtext });
      }}
    /></h4>

                <p className="mt-1">
                    <RichText tagName="span" value={attributes.contentSLc} default="Repudiandae sint consequuntur vel. Amet ut nobis explicabo numquam expedita quia omnis voluptatem. Minus quidem ipsam quia iusto." onChange={ (newtext) => { setAttributes({ contentSLc: newtext }); }} /></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div>
      ...
      <svg
         class="h-full w-16 border border-gray-300 bg-white text-gray-300" preserveAspectRatio="none" stroke="currentColor" fill="none" viewBox="0 0 200 200" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgHYy }}
        >
      </svg>
            ...
            <div>
                 <h4 class="text-lg font-bold"><RichText.Content value={attributes.contentbYM} /></h4>

                <p class="mt-1">
                    <RichText.Content value={attributes.contentSLc} /></p>
            </div>
        </div>
    </div>
</div>
