  ...
  const { Panel, PanelBody, PanelRow, TextareaControl } = wp.components;
        ...
        registerBlockType('wp/aligned-to-bottom', {
      ...
      <PanelRow>
        <div>
          <TextareaControl
            ...
            value={ attributes.svgmFF }
            onChange={ ( value ) => {
              setAttributes({ svgmFF: value });
            } }
          />
        </div>
      </PanelRow>
    ...
    <div>
      ...
      <svg
         className="h-16 w-16 border border-gray-300 bg-white text-gray-300" preserveAspectRatio="none" stroke="currentColor" fill="none" viewBox="0 0 200 200" aria-hidden="true"
          dangerouslySetInnerHTML={ { __html: attributes.svgmFF }}
        >
      </svg>
      
            </div>
            <div>
                 <h4 className="text-lg font-bold"><RichText tagName="span" value={attributes.contentzVQ} default="Lorem ipsum" onChange={ (newtext) =>  {
        setAttributes({ contentzVQ: newtext });
      }}
    /></h4>

                <p className="mt-1">
                    <RichText tagName="span" value={attributes.contentfXC} default="Repudiandae sint consequuntur vel. Amet ut nobis explicabo numquam expedita quia omnis voluptatem. Minus quidem ipsam quia iusto." onChange={ (newtext) => { setAttributes({ contentfXC: newtext }); }} /></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div>
      ...
      <svg
        ...
        >
            ...
            <div>
                 <h4 class="text-lg font-bold"><RichText.Content value={attributes.contentzVQ} /></h4>

                <p class="mt-1">
                    <RichText.Content value={attributes.contentfXC} /></p>
            </div>
        </div>
    </div>
</div>
